    ...
    <section className="py-8 bg-main text-white">
      <div className="container grid grid-cols-2 gap-10 items-center">
        ...
        <form className="col-span-1">
            <div className="flex">
                <input type="email" placeholder="Enter Your Email Address" className="py-2 px-3 outline-none border border-light bg-transparent rounded-s-3xl w-3/4" />
                <button className="w-1/4 py-2 bg-light text-main rounded-e-3xl">
